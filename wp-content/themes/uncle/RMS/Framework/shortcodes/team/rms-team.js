   ...
   // executes this when the DOM is ready
	jQuery(function(){
		...
		var form = jQuery('<div id="team-form"><table id="team-table" class="form-table">\
			<tr>\
				<th><label for="team_view">Team View</label></th>\
				<td><select id="team_view" name="view">\
                                <option value="normal">Normal</option><option value="slide">Slide</option>\
                                </select><br />\
				<small>Select Team View</small></td>\
			</tr>\
			<tr>\
				<th><label for="team_member">Number Of Member</label></th>\
				<td><input type="text" name="member" id="team_member" value="4" /><br />\
